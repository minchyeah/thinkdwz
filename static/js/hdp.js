...
$(function(){
	...
	$("#slider_name .prev,#slider_name .next").css({"opacity":"0.05","filter":"alpha(opacity=05)"}).hover(function(){
		$(this).stop(true,false).animate({"opacity":"0.6","filter":"alpha(opacity=60)"},300);
	},function() {
		$(this).stop(true,false).animate({"opacity":"0.05","filter":"alpha(opacity=05)"},300);
	});
